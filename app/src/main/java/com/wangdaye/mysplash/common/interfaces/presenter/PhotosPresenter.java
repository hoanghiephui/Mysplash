 ...
 * Photos presenter.
 *
 * Presenter for {@link com.wangdaye.mysplash.common.interfaces.view.PhotosView}.
 *
 * */
...
public interface PhotosPresenter {
    ...
    void requestPhotos(Context c, @Mysplash.PageRule int page, boolean refresh, String query);
    void cancelRequest();
