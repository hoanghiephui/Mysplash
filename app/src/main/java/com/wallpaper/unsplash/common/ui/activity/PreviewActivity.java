...
import com.wallpaper.unsplash.common.ui.widget.nestedScrollView.NestedScrollPhotoView;
...
public class PreviewActivity extends BaseActivity
    ...
    private boolean showingIcon = true; // If set true, it means the icon view is visible.
