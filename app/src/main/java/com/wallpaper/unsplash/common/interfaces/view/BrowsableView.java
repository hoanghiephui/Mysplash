...
public interface BrowsableView {
     ...
     * {@link com.wallpaper.unsplash.photo.view.activity.PhotoActivity} implements this interface.
     * When it was opened by a web url intent like <a href="https://unsplash.com/photos/pFqrYbhIAXs" />,
     * it need to request {@link com.wallpaper.unsplash.common.data.entity.unsplash.Photo} data
     * by a HTTP request.
     */
