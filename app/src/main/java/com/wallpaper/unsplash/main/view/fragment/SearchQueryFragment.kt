...
import com.wallpaper.unsplash.common.utils.DisplayUtils.getNavigationBarHeight
...
import com.wallpaper.unsplash.main.view.widget.UsersQueryView
...
class SearchQueryFragment : LoadableFragment<Photo>(),
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        showAds(getString(R.string.banner_search_query_facebook), getString(R.string.banner_category), view)
