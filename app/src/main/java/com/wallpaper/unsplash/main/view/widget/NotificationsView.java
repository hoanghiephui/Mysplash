...
import com.wallpaper.unsplash.common.ui.decotarion.ListDecoration;
...
import com.wallpaper.unsplash.main.model.widget.NotificationsObject;
...
import com.wallpaper.unsplash.main.presenter.widget.NotificationsImplementor;
 ...
 * {@link com.wallpaper.unsplash.main.view.activity.NotificationActivity}.
 *
 * */

public class NotificationsView extends NestedScrollFrameLayout
        implements com.wallpaper.unsplash.common.interfaces.view.NotificationsView, LoadView, ScrollView,
    ...
    public boolean canSwipeBack(int dir) {
        switch (loadPresenter.getLoadState()) {
            case com.wallpaper.unsplash.collection.model.widget.LoadObject.NORMAL_STATE:
