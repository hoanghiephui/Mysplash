...
import com.wallpaper.unsplash.common.interfaces.model.UsersQueryModel
...
import com.wallpaper.unsplash.common.interfaces.presenter.UsersQueryPresenter
...
import com.wallpaper.unsplash.common.interfaces.view.UsersView
...
import com.wallpaper.unsplash.main.model.widget.UsersQueryObject
...
import com.wallpaper.unsplash.main.presenter.widget.UsersQueryImplementor
import java.util.*
 ...
 */
class UsersQueryView(activity: BaseActivity?, id: Int, index: Int, selected: Boolean, private val query: String,
                     private val callBack: UsersQueryAdapter.CallBack) : NestedScrollFrameLayout(activity),
        UsersView,
        PagerView, LoadView, ScrollView, BothWaySwipeRefreshLayout.OnRefreshAndLoadListener, UsersQueryAdapter.CallBack {
    ...
    private fun initModel(activity: BaseActivity?, index: Int, selected: Boolean) {
        this.usersModel = UsersQueryObject(UsersQueryAdapter(this))
