...
public class HomeFragment extends LoadableFragment<Photo>
    ...
    CoordinatorLayout layoutBottom;
    ...
    private HomeTrendingView homeTrendingView;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (getActivity() != null) {
            ...
            activity.compositeDisposable.add(
                    activity.connectionEventObservable
                            .observeOn(AndroidSchedulers.mainThread())
                            .subscribe(connectionEvent -> {
                                if (connectionEvent.equals(ConnectionEvent.SUCCESS_FIREBASE) && viewPager.getCurrentItem() == 0
                                        && homeTrendingView != null
                                        && homeTrendingView.getPhotos().size() == 0) {
                                    homeTrendingView.refreshPager();
                                }
                            }));
        }
    }
    ...
    */
    ...
    private void initView(View view, Bundle savedInstanceState) {
        showAds(getString(R.string.banner_home_facebook), Constants.ADMOB_BANNER_HOME, view);
        ...
        TextView title = view.findViewById(R.id.container_notification_bar_title);
        ...
        if (getActivity() != null && getNavigationBarHeight(getActivity().getResources()) != 0) {
...
*/
        initPages(view, savedInstanceState);
    }

    private void initPages(View v, Bundle savedInstanceState) {
        List<View> pageList = new ArrayList<>();
        pageList.add(
                homeTrendingView = new HomeTrendingView(
