package com.wallpapers.unsplash.main.view.activity;
...
import com.wallpapers.unsplash.main.model.activity.DownloadObject;
import com.wallpapers.unsplash.main.model.activity.DrawerObject;
import com.wallpapers.unsplash.main.model.activity.FragmentManageObject;
import com.wallpapers.unsplash.main.presenter.activity.DownloadImplementor;
import com.wallpapers.unsplash.main.presenter.activity.DrawerImplementor;
import com.wallpapers.unsplash.main.presenter.activity.FragmentManageImplementor;
import com.wallpapers.unsplash.main.presenter.activity.MeManageImplementor;
import com.wallpapers.unsplash.main.presenter.activity.MessageManageImplementor;
...
public class MainActivity extends LoadableActivity<Photo>
    ...
    public static final String ACTION_SEARCH = "com.wallpapers.unsplash.Search";
    ...
    */
    ...
    public void handleBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            BaseFragment fragment = getTopFragment();
            if (fragment != null
                    && fragment.needBackToTop() && BackToTopUtils.isSetBackToTop(true)) {
                fragment.backToTop();
            } else if (fragment instanceof HomeFragment) {
                finishActivity(SwipeBackCoordinatorLayout.DOWN_DIR);
            } else if (fragment instanceof SearchQueryFragment && ((SearchQueryFragment) fragment).isExprore()) {
                changeFragment(R.id.action_explore);
            } else {
    ...
    public void changeFragment(int code) {
        ...
        fragmentManagePresenter.changeFragment(this, code, null, false);
    }

    /**
     * @param code
     * @param title
     * @method thay doi fragment
     */
    public void changeFragment(int code, String title, boolean isExprore) {
        drawerPresenter.setCheckedItemId(code);
        fragmentManagePresenter.changeFragment(this, code, title, isExprore);
    }
