...
public class FragmentManageImplementor
    ...
    @Override
    public void changeFragment(BaseActivity a, int code, String title, boolean isExprore) {
        ...
        if (oldF == null) {
            if (newF == null) {
                newF = buildFragmentByCode(code, title, isExprore);
            }
...
*/
    ...
    private BaseFragment buildFragmentByCode(int code, String title, boolean isExprore) {
        switch (code) {
            ...
            case SEARCH_QUERY_ID:
                return SearchQueryFragment.Companion.newInstance(title, isExprore);
            case R.id.action_explore:
                return new ExproreFragment();
            default:
    ...
    private int getFragmentCode(BaseFragment f) {
        ...
        } else if (f instanceof ExproreFragment) {
