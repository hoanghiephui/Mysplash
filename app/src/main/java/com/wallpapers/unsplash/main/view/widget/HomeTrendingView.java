...
import com.wallpapers.unsplash.main.model.widget.TrendingObject;
...
import com.wallpapers.unsplash.main.presenter.widget.TrendingImplementor;
...
public class HomeTrendingView extends NestedScrollFrameLayout
    ...
    private void initialize(MainActivity a,
        ...
        View contentView = LayoutInflater.from(getContext())
                .inflate(R.layout.view_photo_trending, null);
        addView(contentView);
