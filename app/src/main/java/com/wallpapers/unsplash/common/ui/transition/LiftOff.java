package com.wallpapers.unsplash.common.ui.transition;
...
public class LiftOff extends Transition {
    ...
    private static final String PROPNAME_ELEVATION = "unsplash:liftoff:elevation";
    ...
    public Animator createAnimator(ViewGroup sceneRoot, TransitionValues startValues,
        ...
        return ObjectAnimator.ofFloat(endValues != null && endValues.view != null ? endValues.view : startValues.view, View.TRANSLATION_Z,
