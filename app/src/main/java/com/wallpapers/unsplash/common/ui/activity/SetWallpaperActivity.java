...
import com.wallpapers.unsplash.common.ui.widget.photoView.Info;
import com.wallpapers.unsplash.common.ui.widget.photoView.PhotoView;
...
/**
 * Set wallpapers activity.
 * <p>
 * This activity is used to set a photo as a wallpapers.
 */
...
public class SetWallpaperActivity extends ReadWriteActivity
    ...
    /**
     * Set picture as a wallpapers.
     *
     * @param wallpaper if set true, it means this picture needs to be set as a wallpapers,
    ...
    private void setWallpaper(Bitmap source, boolean wallpaper) {
        ...
        // screen width + delta width = wallpapers width.
        // for example, when the wallpapers is align left. ■□□
                ...
                switch (alignType) {
                    case ALIGN_TYPE_LEFT: {
                        ...
                        if (screenWidth + deltaWidth > screenHeight) {
                            // wallpapers's width cannot > wallpapers's height.
