...
public class Collection implements Parcelable {
     ...
     * keywords : ["wallpapers","tree","lock screen background","iphone background","iphone wallpapers","landscape","mountain","minimalist","countryside","city","nature","notepad","coffee cup","table","turntable"]
     */
