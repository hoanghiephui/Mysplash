package com.wallpapers.unsplash.common.ui.widget.coverView;
...
public class CoverMaskLayoutL extends LinearLayout {
    ...
    public CoverMaskLayoutL(Context context) {
        this(context, null);
    }

    public CoverMaskLayoutL(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CoverMaskLayoutL(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
