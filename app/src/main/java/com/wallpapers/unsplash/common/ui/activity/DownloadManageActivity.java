...
import com.wallpapers.unsplash.common.ui.adapter.DownloadAdapter;
...
public class DownloadManageActivity extends ReadWriteActivity
    ...
    public static final String ACTION_DOWNLOAD_MANAGER = "com.wallpapers.unsplash.DownloadManager";
