...
public class PhotoAdapter extends FooterAdapter<RecyclerView.ViewHolder>
     ...
     */
    @Override
    public void onClickItemTag(String title) {
        ((MainActivity) a).changeFragment(SEARCH_QUERY_ID, title, false);
    }
    ...
    public class PhotoViewHolder extends RecyclerView.ViewHolder
        ...
        void onBindView(PhotoViewHolder photoViewHolder, final int position) {
            ...
            setOnClick(photoViewHolder, position);
        }
        ...
        private void setOnClick(PhotoViewHolder holder, final int position) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (viewType) {
            case HEADER_TYPE:
                ...
                break;
            case CONTENT_TYPE:
                PhotoViewHolder holderContent = (PhotoViewHolder) holder;
        ...
        if (holder instanceof PhotoViewHolder && position < getRealItemCount()) {
        ...
        private void updateView(boolean to) {
            if (recyclerView != null) {
                ...
                if (firstPositions[0] <= position && position <= lastPositions[lastPositions.length - 1]) {
                    PhotoViewHolder holder = (PhotoViewHolder) recyclerView.findViewHolderForAdapterPosition(mPosition);
