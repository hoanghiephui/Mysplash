...
import com.wallpapers.unsplash.common.utils.manager.MuzeiOptionManager;
 ...
 * <p>
 * This activity is used to config Muzei live wallpapers.
 */
...
public class MuzeiConfigurationActivity extends BaseActivity
    ...
    private void initWidget() {
        ...
        SwipeBackCoordinatorLayout swipeBackView = findViewById(R.id.activity_muzei_configuration_swipeBackView);
        swipeBackView.setOnSwipeListener(this);

        Toolbar toolbar = findViewById(R.id.activity_muzei_configuration_toolbar);
        ThemeManager.setNavigationIcon(
                toolbar, R.drawable.ic_toolbar_close_light, R.drawable.ic_toolbar_close_dark);
        toolbar.setNavigationOnClickListener(v -> finishActivity(SwipeBackCoordinatorLayout.DOWN_DIR));
