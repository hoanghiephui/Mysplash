 ...
 * Title holder.
 * <p>
 * PhotoViewHolder class for {@link FollowingAdapter} to show the title part of following feed data.
 */
 ...
 * Photo holder.
 * <p>
 * PhotoViewHolder class for {@link FollowingAdapter} to show photo data.
 */
class PhotoHolder extends RecyclerView.ViewHolder
        implements ImageHelper.OnLoadImageListener<Photo>, DownloadRepeatDialog.OnCheckOrDownloadListener {
    ...
    void onBindView(Context a, Photo photo, int position, int columnCount) {
        ...
        if (this.photo != null) {
            ...
            ImageHelper.loadRegularPhoto(a, image, photo, getAdapterPosition(), this);
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                image.setTransitionName(photo.id + "-" + getAdapterPosition() + "-cover");
                background.setTransitionName(photo.id + "-" + getAdapterPosition() + "-background");
            }
        }
    }
 ...
 * User holder.
 * <p>
 * PhotoViewHolder class for {@link FollowingAdapter} to show user information.
 */
 ...
 * More holder.
 * <p>
 * PhotoViewHolder class for {@link FollowingAdapter} to show "more" information.
 */
