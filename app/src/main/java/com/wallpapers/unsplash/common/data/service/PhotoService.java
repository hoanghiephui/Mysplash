...
public class PhotoService {
    ...
    public void requestPhotos(@Unsplash.PageRule int page,
    ...
    public void requestCuratePhotos(@Unsplash.PageRule int page,
                                    @Unsplash.PerPageRule int per_page,
                                    String order_by,
                                    final OnRequestPhotosListener l) {
    ...
    public void requestRandomPhotos(Integer categoryId,
        ...
        Call<List<Photo>> getRandomPhotos = buildApi(buildClient()).getRandomPhotos(
                categoryId, featured,
                username, query,
                orientation, Unsplash.DEFAULT_PER_PAGE);
     ...
     */
    public void requestPhotoByQuery(String query, @Unsplash.PageRule int page,
                                    @Unsplash.PerPageRule int per_pag, final OnRequestPhotoByQueryListener listener) {
