package com.wallpapers.unsplash.user.view.activity;
...
import com.wallpapers.unsplash.user.model.activity.DownloadObject;
import com.wallpapers.unsplash.user.model.activity.PagerManageObject;
import com.wallpapers.unsplash.user.model.widget.PhotosObject;
import com.wallpapers.unsplash.user.presenter.activity.BrowsableImplementor;
import com.wallpapers.unsplash.user.presenter.activity.DownloadImplementor;
import com.wallpapers.unsplash.user.presenter.activity.PagerManageImplementor;
import com.wallpapers.unsplash.user.presenter.activity.PopupManageImplementor;
import com.wallpapers.unsplash.user.presenter.activity.SwipeBackManageImplementor;
import com.wallpapers.unsplash.user.presenter.activity.ToolbarImplementor;
import com.wallpapers.unsplash.user.view.widget.UserCollectionsView;
import com.wallpapers.unsplash.user.view.widget.UserPhotosView;
import com.wallpapers.unsplash.user.view.widget.UserProfileView;
