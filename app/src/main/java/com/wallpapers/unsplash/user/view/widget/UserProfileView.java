...
import com.wallpapers.unsplash.user.model.widget.UserObject;
import com.wallpapers.unsplash.user.presenter.widget.LoadImplementor;
import com.wallpapers.unsplash.user.presenter.widget.UserImplementor;
...
public class UserProfileView extends FrameLayout
    ...
    private void initialize() {
        View v = LayoutInflater.from(getContext()).inflate(R.layout.container_user_profile, this, false);
        addView(v);
