...
import com.wallpapers.unsplash.common.ui.adapter.MiniTagAdapter;
...
import com.wallpapers.unsplash.me.model.activity.DownloadObject;
import com.wallpapers.unsplash.me.model.activity.PagerManageObject;
import com.wallpapers.unsplash.me.model.widget.PhotosObject;
import com.wallpapers.unsplash.me.presenter.activity.DownloadImplementor;
import com.wallpapers.unsplash.me.presenter.activity.PagerManageImplementor;
import com.wallpapers.unsplash.me.presenter.activity.PopupManageImplementor;
import com.wallpapers.unsplash.me.presenter.activity.SwipeBackManageImplementor;
import com.wallpapers.unsplash.me.presenter.activity.ToolbarImplementor;
import com.wallpapers.unsplash.me.view.widget.MeCollectionsView;
import com.wallpapers.unsplash.me.view.widget.MePhotosView;
import com.wallpapers.unsplash.me.view.widget.MeProfileView;
...
public class MeActivity extends LoadableActivity<Photo>
        ...
        SelectCollectionDialog.OnCollectionsChangedListener, AuthManager.OnAuthDataChangedListener, RippleButton.OnSwitchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initPresenter();
        showAds(getString(R.string.banner_collection_fb), Constants.ADMOB_BANNER_PROFILE);
    }
    ...
    private void drawProfile() {
        ...
        if (user != null) {
            ...
            meProfileView.drawMeProfile(user);
            rippleButton.setVisibility(View.VISIBLE);
            rippleButton.forceSwitch(true);
            rippleButton.setButtonTitles(
                    new String[]{
                            getString(R.string.my_follow).toUpperCase(),
                            getString(R.string.my_follow).toUpperCase()});
            ImageHelper.loadAvatar(this, avatar, user);
            if (tags == null || !isSameTags(user.tags.custom, tags)) {
                if (user.tags.custom == null || user.tags.custom.size() == 0) {
                    tagList.setVisibility(GONE);
                } else {
                    tags = user.tags.custom;
                    tagList.setAdapter(new MiniTagAdapter(user.tags.custom));
                }
            }
